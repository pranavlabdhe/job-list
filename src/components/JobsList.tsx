...
const JobsList: React.FC<Props> = ({ jobs, setJobsTodo, word }) => {
  ...
  const EditText = (id: number, job: string) => {
    setEditId(id);
    setEditValue(job);
  };
                            ...
                            <>
                              ...
                              <div className='col-6 text-end '>
                                <div className='actions'>
                                  {!isDone ? (
                                    <>
                                      <i className='fas fa-edit edit-icon ic mt-1' onClick={() => EditText(id, job)}></i>
                                      <i className='fas fa-check-circle ic mt-1' onClick={() => handleToggleDone(id)}></i>
                                    </>
                                  ) : (
                                    <i className='fas fa-undo ic mt-1' onClick={() => handleToggleDone(id)}></i>
                                  )}
