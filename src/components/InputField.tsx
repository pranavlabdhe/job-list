    ...
    <form onSubmit={handleJobs}>
      ...
      <div className="parent_body">
        <div className="d-flex col-12">
            <div className="col-12 col-sm-4 col-md-4 col-lg-4 d-flex justify-content-center">
            <h2 className="title">JOB LIST <img src={toDoImg} alt="todo_image" /></h2>
            </div>
        <div className="col-12 col-sm-4 col-md-4 col-lg-6 d-flex justify-content-end">
